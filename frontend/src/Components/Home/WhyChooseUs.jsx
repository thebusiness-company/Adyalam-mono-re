...
const WhyChooseUs = () => {
  const chooseContent = {
    ...
    title: "Because you don’t need more noise. You need marketing that works.",
    content:
    ...
    img: "/assets/img/home/whychooseadyalam.webp",
  ...
  return (
    <section className="team-section fix section-padding2">
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-6">
              <div className="team-content">
                ...
                <p className="text-black">We work as partners, not vendors.</p>
              </div>
            </div>
          </div>
        </div>
