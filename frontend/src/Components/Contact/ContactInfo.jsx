...
const ContactInfo = () => {
    ...
    useEffect(() => {
      ...
      if (service === "dm") {
        setDmPlan(digitalMarketingPlans[plan] ? plan : "");
        setWebsitePlan("");
      }

      if (service === "website") {
        setWebsitePlan(websitePlans[plan] ? plan : "");
        setDmPlan("");
      }
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const res = await fetch(`${API_BASE_URL}/contact`, {
          ...
          body: JSON.stringify({ name, email, phone, subject, dmPlan, websitePlan, accepted, message }),
        });
        if (!res.ok) {
    ...
    return (
      <div>
          ...
          <div className="container">
            <div className="row g-4">
              <div
                ...
                data-wow-delay=".3s"
              >
                <div className="contact-info-items text-center active w-100">
                  <div className="icon">
              ...
              <div
                ...
                data-wow-delay=".5s"
              >
                <div className="contact-info-items text-center w-100">
                  <div className="icon">
                  ...
                  <div className="content">
                    <h3>
                      <a
                        href="mailto:hello.adyalam@gmail.com"
              ...
              >
                <div className="contact-info-items text-center w-100">
                  ...
                  <div className="content">
                    <h3>
                      Call:<a href="tel:89259 75486">+91 89259 75486</a>
                    </h3>
                    <p>
        ...
        <section
          id="contact-form"
          className="contact-section-33 fix section-padding2 pt-0"
        >
          <div className="container">
                      ...
                      <div className="contact-form-area">
                        ...
                        <form id="contact-form" onSubmit={handleSubmit}>
                          <div className="row g-4">
                            ...
                            <div className="col-12">
                              <div className="form-check">
                                <input
                                  ...
                                  type="checkbox"
                                  id="flexCheckChecked"
                                  aria-invalid={!!validationErrors.accepted}
                                  checked={accepted}
                                  onChange={(e) => {
                            ...
                            {success && (
                              <div className="col-12 mt-2 text-success">
                                {success}
                              </div>
                            )}
                            {error && (
